...
以前出現したデータが再出現したら
「何個前のデータを使う」という様に変換して圧縮するアルゴリズム
...
データの出現頻度から
データに符号を割り当てることで全体のビット数を減らすアルゴリズム
...
STEP1 の変換ファイルを解析し、頻繁に使われるものに短い数値コードを、あまり使わないものに長い数値コードを与える。
...
何気なく使っている圧縮ですが、実は意外と単純なアルゴリズムなのです。
